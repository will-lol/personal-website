...
let observerText = new IntersectionObserver(entries => {
    if (entries[0].boundingClientRect.y < 0) {
        ...
        setTimeout(stopAnim => {
            document.getElementById("scrollingText__text").style.animationPlayState = 'paused';
        }, 1000)
    } else {
        document.getElementById("scrollingText__text").style.animationPlayState = 'running';
